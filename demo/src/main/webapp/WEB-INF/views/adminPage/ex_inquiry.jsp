...
<div class="wrapper">
	...
	<h1 style="text-align: center; " >1 : 1 문의 관리</h1>
	 <!-- Main content -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">1:1 문의 리스트</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
			...
			error : function(){
				alert("실패");
                 ...
                 <tr>
                  ...
                  <tr class="up${inquiry.inquiry_no}">
                    <td class="n_no${inquiry.inquiry_no}">${inquiry.inquiry_no}</td>
                    <td><a href="/customer/notice_view?notice_no=${inquiry.inquiry_no}">${inquiry.inquiry_title}</a></td>
                   <td>${n.user.user_name}</td>
                  	<td><fmt:formatDate value="${inquiry.inquiry_date }" pattern="yyyy-MM-dd"/></td>
                  	<td>
                  		<input type="button" onclick="mBtn(${inquiry.inquiry_no})" class="btn btn-sm btn-primary" value="수정"> 
                  		<input type="button" onclick="dBtn(${inquiry.inquiry_no})" class="btn btn-sm btn-secondary" value="삭제">
                  	</td>
                  </tr>
                  </c:forEach>
                  <!-- 반복 -->
